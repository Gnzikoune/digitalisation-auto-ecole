...
export class InspectionsController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Lister les inspections (filtrage par rôle automatique)',
  })
  findAll(@Req() req: { user: Record<string, string> }) {
